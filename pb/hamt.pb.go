...
type Node struct {
	Bitfield []byte     `protobuf:"bytes,1,opt,name=bitfield,proto3" json:"bitfield,omitempty"`
...
var fileDescriptor_89dab58ee42fbc88 = []byte{
	...
	,
}
...
func (this *Node) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.Bitfield, that1.Bitfield) {
		return false
	}
...
func (m *Node) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Bitfield) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintHamt(dAtA, i, uint64(len(m.Bitfield)))
		i += copy(dAtA[i:], m.Bitfield)
	}
	if len(m.Pointers) > 0 {
...
func (m *Node) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Bitfield = append(m.Bitfield[:0], dAtA[iNdEx:postIndex]...)
			if m.Bitfield == nil {
				m.Bitfield = []byte{}
			}
			iNdEx = postIndex
